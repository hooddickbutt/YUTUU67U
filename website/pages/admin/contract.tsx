            ...
            <div className="space-y-4 text-xs">
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-white font-mono p-2 bg-zinc-950 border border-zinc-900 flex-1 break-all">
                    {WEB3_CONFIG.NFT_CONTRACT_ADDRESS}
                  </span>
                  <button
                    onClick={() => copyToClipboard(WEB3_CONFIG.NFT_CONTRACT_ADDRESS)}
                    className="px-3 py-2 bg-zinc-800 text-white font-bold"
                  >
                    COPY
                  </button>
                </div>
              ...
              <div className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block px-4 py-2 border border-[#CCFF00]/40 text-[#CCFF00] hover:bg-[#CCFF00]/10 font-bold"
                >

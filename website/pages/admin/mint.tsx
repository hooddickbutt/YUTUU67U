        ...
        <div className="space-y-6">
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                disabled={!publicMintEnabled}
                className="px-6 py-2.5 bg-red-600 text-white font-bold text-xs disabled:opacity-30"
              >
                DISABLE PUBLIC MINT
              </button>
            </div>
          ...
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
            ...
            <div className="space-y-3 max-w-md">
              ...
              />
              <button onClick={updatePrice} className="px-6 py-2.5 bg-[#CCFF00] text-black font-bold text-xs">
                UPDATE PRICE
              </button>
            </div>
          </div>

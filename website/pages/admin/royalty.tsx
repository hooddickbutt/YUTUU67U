        ...
        <div className="space-y-6">
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
            ...
            <div className="text-xs space-y-1">
              ...
              <span className="text-[#CCFF00] font-bold text-sm">{(royaltyFeeBps / 100).toFixed(2)}%</span>
            </div>
            ...
            <div className="space-y-3 max-w-md pt-2">
              ...
              <input
                ...
                className="w-full bg-zinc-950 border border-zinc-800 p-2.5 text-xs text-white focus:border-[#CCFF00] outline-none"
              />
              <button onClick={updateRoyalty} className="px-6 py-2.5 bg-[#CCFF00] text-black font-bold text-xs">
                UPDATE ROYALTY
              </button>
            </div>
          </div>
